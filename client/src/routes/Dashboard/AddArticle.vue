<template>
  <section>
    ...
    <v-layout mt-4 align-center justify-center column>
      <h1 class="mb-2">Add new article</h1>
      <v-form ref="form" class="pa-3 pt-4 card-bg article-form">
        <v-text-field
          box
          v-model="title"
          color="secondary"
        ...
        <v-checkbox v-model="isImage" color="secondary">
        ...
        <v-checkbox :disabled="true" color="primary">
          <template slot="label">
            I agree to the&nbsp;
        ...
        <v-flex v-if="error" class="error--text text-xs-center subheading">{{ error }}</v-flex>
